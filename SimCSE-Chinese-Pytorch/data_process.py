...
if __name__ == '__main__':
    ...
    dev_src, dev_dst = './data/cnsd-snli/cnsd_snli_v1.0.dev.jsonl', './datasets/dev.txt'
    test_src, test_dst = './data/cnsd-snli/cnsd_snli_v1.0.test.jsonl', './datasets/test.txt'
    train_src, train_dst = './data/cnsd-snli/cnsd_snli_v1.0.train.jsonl', './datasets/train.txt'
